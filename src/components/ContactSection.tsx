...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-20 lg:py-24 bg-[#F8FAFC] border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3 mb-16">
          ...
          <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0F172A] tracking-tight">
            Contact Smartech in <span className="text-[#1D4ED8]">Sialkot</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
          ...
          <div className="lg:col-span-5 space-y-6 text-left">
            <div className="p-6 bg-white border-l-4 border-[#0F172A] border-y border-r border-gray-200 space-y-6 rounded-xs shadow-xs">
              <div>
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-blue-50 border border-blue-100 text-[#1D4ED8] flex items-center justify-center flex-shrink-0 rounded-xs">
                    <MapPin className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Business Location</div>
                    <div className="text-sm sm:text-base font-bold text-[#0F172A]">
                      {COMPANY_INFO.location}
                    </div>
                    <div className="text-xs text-slate-600">Serving Residential, Commercial & Industrial Projects</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Direct Phone / Helpline</div>
                    <a
                      href={`tel:${COMPANY_INFO.phoneRaw}`}
                      className="text-sm sm:text-base font-bold text-[#0F172A] hover:text-[#1D4ED8] transition-colors"
                    >
                      {COMPANY_INFO.phone}
                    </a>
                    <div className="text-xs text-slate-600">Available Mon - Sat for Inquiries</div>
                  </div>
                </div>

                {/* WhatsApp */}
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-emerald-50 border border-emerald-200 text-emerald-600 flex items-center justify-center flex-shrink-0 rounded-xs">
                    <MessageSquare className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-[10px] text-slate-500 font-bold uppercase tracking-wider">Official WhatsApp</div>
                    <a
                    ...
                    <div className="text-xs text-slate-600">Instant Chat & Document/Drawing Sharing</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-slate-600">Official Quotation & RFQ Submissions</div>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-4 border-t border-gray-200 grid grid-cols-2 gap-3">
                <a
                  href={`tel:${COMPANY_INFO.phoneRaw}`}
                  className="inline-flex items-center justify-center gap-2 py-2.5 px-3 bg-[#0F172A] hover:bg-[#1D4ED8] text-white text-xs font-bold uppercase tracking-wider transition-colors rounded-xs"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 py-2.5 px-3 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold uppercase tracking-wider transition-colors rounded-xs"
                >
          ...
          <div className="lg:col-span-7 text-left">
            <div className="p-7 sm:p-9 bg-white border-l-4 border-[#1D4ED8] border-y border-r border-gray-200 shadow-xs rounded-xs">
              <div className="mb-6">
              ...
              {submitted ? (
                <div className="p-8 bg-slate-50 border border-emerald-300 text-center space-y-4 rounded-xs">
                  ...
                  <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs uppercase tracking-widest rounded-xs"
                    >
                    ...
                    <button
                      ...
                      className="text-xs text-slate-500 hover:text-[#0F172A] underline font-bold uppercase tracking-wider"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3.5 py-2.5 bg-[#F8FAFC] border border-gray-300 text-sm text-[#0F172A] placeholder-slate-400 focus:outline-none focus:border-[#1D4ED8] focus:bg-white rounded-xs"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full px-3.5 py-2.5 bg-[#F8FAFC] border border-gray-300 text-sm text-[#0F172A] focus:outline-none focus:border-[#1D4ED8] focus:bg-white font-medium rounded-xs"
                      >
                  ...
                  <div className="pt-3 flex flex-col sm:flex-row items-center gap-3">
                    <button
                      type="submit"
                      disabled={submitting}
                      className="w-full sm:w-1/2 inline-flex items-center justify-center gap-2 py-3.5 px-6 bg-[#1D4ED8] hover:bg-[#2563EB] text-white font-bold text-xs uppercase tracking-widest shadow-xs transition-all rounded-xs disabled:opacity-75"
                    >
                      {submitting ? (
                    ...
                    <button
                      type="button"
                      onClick={handleWhatsAppForward}
                      className="w-full sm:w-1/2 inline-flex items-center justify-center gap-2 py-3.5 px-6 bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs uppercase tracking-widest shadow-xs transition-all rounded-xs"
                    >
                      <MessageSquare className="w-4 h-4" />
                  ...
                  <p className="text-[10px] text-slate-500 text-center pt-2 font-mono uppercase tracking-wider">
